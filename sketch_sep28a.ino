...
/*
  Since Output is READ_WRITE variable, onOutputChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onOutputChange()  {
  // Add your code here to act upon Output change
}
/*
